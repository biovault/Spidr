...
# -----------------------------------------------------------------------------
# usage: 
#  spidr_check_and_set_AVX(${TARGET} ${USE_AVX})
#  spidr_check_and_set_AVX(${TARGET} ${USE_AVX} 1)    # optional argument, only use AVX (not AVX2 even if available)

macro(spidr_check_and_set_AVX target useavx)
...
# -----------------------------------------------------------------------------
macro(spidr_set_optimization_level target level)
